<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="WEDDING_WARE.Admin.Category" %>
                        ...
                        <asp:Repeater ID="rCategory" runat="server" OnItemCommand="rCategory_ItemCommand">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <img width="40" src="<%# WEDDING_WARE.Utils.getImageUrl( Eval("CategoryImageUrl")) %>" alt="Image" />
                                    </td>
                                    <td>
